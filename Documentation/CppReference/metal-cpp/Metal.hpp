...
// Metal.hpp
//
// Autogenerated from commit 3d9b13ffc86577578ff7e91f5c7b27864a6a30dc.
//
...
public:
    ...
    SharedPtr(const SharedPtr<_OtherClass>& other, typename std::enable_if<std::is_convertible<_OtherClass *, _Class *>::value>::type * = nullptr) noexcept;
     ...
     */
    template <class _OtherClass>
    SharedPtr(SharedPtr<_OtherClass>&& other, typename std::enable_if<std::is_convertible<_OtherClass *, _Class *>::value>::type * = nullptr) noexcept;
     ...
     */
    template <class _OtherClass>
    typename std::enable_if<std::is_convertible<_OtherClass *, _Class *>::value, SharedPtr &>::type
...
template <class _Class>
template <class _OtherClass>
_NS_INLINE NS::SharedPtr<_Class>::SharedPtr(const NS::SharedPtr<_OtherClass>& other, typename std::enable_if<std::is_convertible<_OtherClass *, _Class *>::value>::type *) noexcept
...
template <class _Class>
template <class _OtherClass>
_NS_INLINE NS::SharedPtr<_Class>::SharedPtr(NS::SharedPtr<_OtherClass>&& other, typename std::enable_if<std::is_convertible<_OtherClass *, _Class *>::value>::type *) noexcept
...
template <class _Class>
template <class _OtherClass>
typename std::enable_if<std::is_convertible<_OtherClass *, _Class *>::value, NS::SharedPtr<_Class> &>::type
